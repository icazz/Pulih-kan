...
const tabs = ['Semua', 'Menunggu Pembayaran', 'Dalam Pengerjaan', 'Selesai'];

// --- LOGIC STATUS BADGE (DIPINDAHKAN KE SINI AGAR TERBACA TAILWIND) ---
                    ...
                    <div class="flex-grow flex flex-col justify-between py-1">
                        ...
                        <div class="space-y-2 mb-4">
                            ...
                            <div class="flex items-center gap-3">
                                <div class="w-5 flex justify-center"><svg class="w-5 h-5 text-[#4B741F]" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4"></path></svg></div>
                                <span class="text-gray-500 text-sm md:text-base">{{ report.vendor_name }}</span>
                            </div>
                            <div class="flex items-center gap-3">
